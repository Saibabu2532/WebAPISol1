...
{
    public class MyExceptionFiltersAttribute : ExceptionFilterAttribute
    {
        ...
        {
            //Write Any Logic to Log The Issue and Handling exception
             Exception ex = context.Exception;

            //Logging Exception into a text file 
            SendErrorToText(ex);

            context.Result = new ObjectResult("Somethig went Wrong ..!\n" + "Issue : " + ex.Message + ".\nwe will solve this issue soon ...1")
            {
                StatusCode = 400
            };
